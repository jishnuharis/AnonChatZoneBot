...
HELP_TEXT = (
    ...
    "\t\tThis bot relays text, stickers, photos, videos, GIFs, voice and video notes between you and your partner with real-time typing indicators and native emoji reaction mirroring. Want to talk directly? Start a private audio room with /call. Want to break the ice? Challenge your partner to a mini-game with /games - Tic Tac Toe, Rock Paper Scissors, Guess It, Would You Rather, Trivia Duel, or Coin Steal.\n\n"
    "<b>Commands:</b>\n"
    "/start - <i>Show the welcome message</i>\n"
    "/find - <i>Find a new partner (matched by shared interests when possible)</i>\n"
    "/next - <i>Skip the current chat and find someone new (with 60s undo)</i>\n"
    "/stop - <i>Stop the current chat (with 60s undo)</i>\n"
    "/nudge - <i>Send a gentle nudge to your chat partner</i>\n"
    "/status - <i>Check partner connection & activity status</i>\n"
    "/friendreq - <i>Send an anonymous friend request to your partner</i>\n"
    "/friends - <i>Manage your anonymous friends list & reconnect</i>\n"
    "/call - <i>Start a private anonymous voice call via WebApp</i>\n"
    "/block - <i>Block your current partner permanently</i>\n"
    "/profile - <i>Show your profile, edit your info & interests</i>\n"
    "/games - <i>Play a mini-game with your partner</i>\n"
    "/private - <i>Send a photo, video, voice or video note in Privacy Mode</i>\n"
    "/subscribe - <i>View plans for higher daily credits, unlimited media sends & VIP perks</i>\n"
    "/help - <i>Show this message</i>\n\n"
    "<b>Anonymous Friends & Voice Calls:</b>\n"
    "\t\tHit it off with someone? Send a friend request with /friendreq to stay in touch anonymously. Manage your connections anytime in /friends to chat again later without revealing your Telegram username. You can also start an anonymous 1-on-1 audio call with /call.\n\n"
    "<b>Accidental Disconnects & Memories:</b>\n"
    "\t\tSkipped or stopped by mistake? Tap the 60-second Undo button to reconnect instantly if neither of you has matched yet. When a great conversation ends, you can also download a clean, 100% anonymized transcript directly to your Saved Messages.\n\n"
    "<b>Daily credits:</b>\n"
    "\t\tFree accounts share a daily credit pool between /next skips and photo/video/voice/video note sends, resetting at midnight UTC. Subscribers get a bigger pool, unlimited free media sends, partner gender peek on match, and unlock Privacy Mode — see /subscribe for plans.\n\n"
    "<b>Referral bonus:</b>\n"
    "\t\tGrab your personal invite link anytime from the 🔗 button on /profile. When a referral promo is running, getting enough friends to join through it and finish setting up their profile earns you a free subscription — you might also see this pop up while using the bot.\n\n"
    "<b>Staying safe:</b>\n"
    "\t\tEvery chat ends with the option to rate or report your partner. Reports are reviewed and repeated bad behaviour gets punished automatically. If you ever get restricted and think it's a mistake, just reach out to a bot admin to get it sorted."
)
